        ...
        <div v-else>
          ...
          <div class="form-group">
            <label for="content" class="text-muted"
              >Please describe your experiance:</label
            >
            <textarea
              name="content"
              cols="30"
...
export default {
  ...
  created() {
    this.loading = true;
    //1. treba proveriti da li review postoji, uz pomoc id-ja u reviews tabeli
    //1.2. ukoliko je korisnik ostavio rivju treba ga obavestiti
    axios
      ...
      .catch((err) => {
        //2. ako rivju ne postoji, moramo da povicemo podatke o bookingu uz pomoc rivju kljuca
        if (
          err.response &&
          err.response.status &&
